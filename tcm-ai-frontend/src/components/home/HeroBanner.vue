        ...
        <div class="scroll-container">
          ...
          <div class="scroll-paper" ref="scrollPaper">
            ...
            <div class="paper-content">
              <div class="main-title">AI上中医</div>
      ...
      <section class="banner" id="home">
        <div class="banner-content reveal-item">
          ...
          <div class="text-container">
            ...
            <div class="btn-group">
              <button class="btn btn-primary btn-start" @click="handleStartClick">
                <span>开始体验</span>
...
.main-title {
  font-size: 4.2rem;
  font-weight: 700;
  background: linear-gradient(135deg, #b47c44, #613d1e, #8b5a2e);
  background-clip: text;
  -webkit-background-clip: text;
  color: transparent;
  letter-spacing: 12px;
  margin-bottom: 1rem;
  text-shadow: 2px 2px 12px rgba(180, 120, 50, 0.3);
  animation: gentlePulse 2.4s infinite alternate;
}
...
@keyframes gentlePulse {
  0% { text-shadow: 0 0 1px #f3cf8c; letter-spacing: 10px;}
  100% { text-shadow: 0 0 6px #ffdfa5, 0 0 2px #dba350; letter-spacing: 12px;}
}
@keyframes yinFloat {
